...
## 4. Test Engineering & 1-to-1 Mapping Rules (`test-engineer`)
...
## 5. Jakarta Validation & JSpecify Boundary Rules (`security-analyst`)
...
## 6. Angular 17+ Signals & Material Design 3 (ADR-011-014)
...
## 7. Liquibase Database Migration Rules (ADR-023)
